...
struct ExecutionReportData : public NotificationBase
{
    ...
    ExecutionReportData(
        ...
        int executed_qty_,
        double execution_price_) : NotificationBase(NotificationType::EXECUTION_REPORT, symbol_),
...
struct MarketDataUpdate : public NotificationBase
{
    ...
    MarketDataUpdate(
        ...
        long total_volume_) : NotificationBase(NotificationType::MARKET_DATA_UPDATE, symbol_),
